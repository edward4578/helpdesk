...
<div class="row">    
    ...
    <div class="col-sm-4">
        <a class="btn btn-success btn-block btn-flat" href="{{ route('tecnico.beneficiario.index') }}" role="button"><span class="fa fa-chevron-left" aria-hidden="true"> Regresar</span></a>
    </div>
</div>
@endsection
@section('scripts')
